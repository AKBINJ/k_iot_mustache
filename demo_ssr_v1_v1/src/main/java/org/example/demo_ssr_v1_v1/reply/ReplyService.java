...
import org.example.demo_ssr_v1_v1.board.Board;
import org.example.demo_ssr_v1_v1.board.BoardRepository;
import org.example.demo_ssr_v1_v1.user.User;
import org.example.demo_ssr_v1_v1.user.UserRepository;
...
public class ReplyService {
    ...
    public Reply 댓글작성(ReplyRequest.SaveDTO saveDTO, Long sessionUserId) {
        ...
        // 비영속성 상태입니다. (개발자 직접 new 해서 객체를 생성함)
    ...
    public Long 댓글삭제(Long replyId, Long sessionUserId) {
        // 댓글 조회 (findById(replyId) --> LAZY 때문에 댓글 작성자 정보는 없다.
        ...
        // 컨트롤러 단에서 리다이렉트 처리해서 다시 게시글 상세보기 호출하기 위한 board id 값
        return boardId;
    }
}
