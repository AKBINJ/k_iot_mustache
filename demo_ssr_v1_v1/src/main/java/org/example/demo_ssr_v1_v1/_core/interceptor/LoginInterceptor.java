package org.example.demo_ssr_v1_v1._core.interceptor;
 ...
 * 로그인 하지 않은 사용자는 E..401로 던질 예정..
 */
// 1. HandlerInterceptor 구현해야 한다.
@Component // IoC 컨테이너에 이 클래스를 빈 객체로 등록함 (싱글톤 패턴으로 관리 됨)
public class LoginInterceptor implements HandlerInterceptor {

    /**
     * preHandle : 컨트롤러 진입 전에 실행되는 메서드
     * 동작 흐름 - 요청이 들어오면 (등록된 URI시) 컨트롤러 보다 먼저 동작함
     *
